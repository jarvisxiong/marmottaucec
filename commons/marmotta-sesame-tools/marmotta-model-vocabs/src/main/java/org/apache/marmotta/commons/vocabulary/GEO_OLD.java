...
public class GEO_OLD {
    ...
    static{
        ...
        Point = factory.createURI(GEO_OLD.NAMESPACE, "Point");
        SpatialThing = factory.createURI(GEO_OLD.NAMESPACE, "SpatialThing");
        alt = factory.createURI(GEO_OLD.NAMESPACE, "alt");
        lat = factory.createURI(GEO_OLD.NAMESPACE, "lat");
        lat_long = factory.createURI(GEO_OLD.NAMESPACE, "lat_long");
        location = factory.createURI(GEO_OLD.NAMESPACE, "location");
        long_ = factory.createURI(GEO_OLD.NAMESPACE, "long");
    }
}
