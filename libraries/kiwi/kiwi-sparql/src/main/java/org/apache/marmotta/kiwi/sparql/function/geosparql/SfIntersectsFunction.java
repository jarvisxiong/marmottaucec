...
public class SfIntersectsFunction implements NativeFunction {
    ...
    public String getNative(KiWiDialect dialect, String... args) {
        if(dialect instanceof PostgreSQLDialect) {
         ...
         //       { 
                return "st_Intersects(substring( " + args[0] + " from position('POINT' in " + args[0] + "  ) for 60 ), substring( " + args[1] + " from position('MULTIPOLYGON' in " + args[1] + " ) for char_length( " + args[1] + " ) ) ) ";
              //  }
            //    else
